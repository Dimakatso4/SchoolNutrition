...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  constructor(@Inject(DOCUMENT) private document: Document, private routerlink: Router, private renderer: Renderer2, router: Router, private authService: AuthService, private appService: AppService) {
...
console.log(this.menuItems[0].username );
