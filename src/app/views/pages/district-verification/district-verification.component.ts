...
@Component({
  ...
  templateUrl: './district-verification.component.html',
  styleUrls: ['./district-verification.component.scss']
})
export class DistrictVerificationComponent implements OnInit {
...
//
  ...
  constructor(private modalService: NgbModal,private verificationService: DistrictVerificationService, private formBuilder: FormBuilder, private router: Router, private http: HttpClient) { }
