...
export class SendNsnpRegistrationService {
  ...
  createSendNSNP(nsnpInfo)
  {
      return this.http.post(this.base_url + "api/NSNP/CreateSendNSNP",nsnpInfo).subscribe(data => {
    }, error => {
      alert("creation unsuccesful")
    });
  }
  ...
  sendEmailToSchool(username,id,district,school)
  {
  ...
  getSendNSNP()
  {
    return this.http.get(this.base_url + "api/NSNP/GetSendNSNP");
  }
