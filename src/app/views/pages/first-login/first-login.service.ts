...
export class FirstLoginService {
  ...
  validatePassword(id, pass) {
    return this.http.get(this.base_url + "api/User/ValidatePassword?Id=" + id + "&Pass=" + encodeURIComponent(pass));
  }

  updateUserPassword(id, pass) {
    return this.http.post(this.base_url + "api/User/UpdateUser?Id=" + id + "&credentials=" + encodeURIComponent(pass), { headers: this.Header });
  }
