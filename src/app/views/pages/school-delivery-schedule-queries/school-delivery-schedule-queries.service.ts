...
export class DeliveryScheduleQueriesService {
...

  {
      ...
      return this.http.get(this.base_url + "api/PerishableProduct/GetQueryList");
  ...
  getDocumentSchoolSupplierSummaryByEmisNo(EmisNo) {
    return this.http.get(this.base_url + "api/SupplierSummary/GetSupplierSummaryByEmisNo?EmisNo=" + EmisNo)
  }
  ...
  getQueryByID(id){
     return this.http.get(this.base_url + "api/PerishableProduct/GetQueryById?Id="+id);
  }
