...
@Component({
  selector: 'app-non-p-delivery',
  templateUrl: './non-p-delivery.component.html',
  styleUrls: ['./non-p-delivery.component.scss']
})
export class NonPDeliveryComponent implements OnInit {
  ...
  openEditModel1(content){  this.modalService.open(content, { size: 'xl' }).result.then((result) => {
